...
int main(void)
{
  ...
  // Example 2: Test Matrix Transpose
  test_mat_trans_f64();  // C = A^T

  // Example 3: Test Matrix Addition
  //test_mat_add_f64();    // C = A + B

  // Example 4: Test Matrix Subtraction
  test_mat_sub_f64();    // C = A - B

  // Example 5: Test Matrix Inverse
  test_mat_inverse_f64(); // C = A^-1
